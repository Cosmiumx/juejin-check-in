...
- [掘金签到助手](#掘金签到助手)
  ...
  - [✨ 功能特性](#-功能特性)
  - [📦 安装方法](#-安装方法)
    - [方法一：通过谷歌插件商店安装（推荐）](#方法一通过谷歌插件商店安装推荐)
    - [方法二：开发者模式安装](#方法二开发者模式安装)
  - [📖 使用说明](#-使用说明)
    - [基本使用流程](#基本使用流程)
    - [状态提示说明](#状态提示说明)
  - [🛠 技术架构](#-技术架构)
...
1. 打开 Chrome 浏览器，访问 [谷歌插件商店](https://chrome.google.com/webstore)

2. 搜索 "掘金签到助手" 或直接访问扩展页面
